...
const AnimatedImage = ({ className = "" }) => {
  return (
    <motion.img
      src={profileImg}
      alt="Harshika Jain"
      className={`w-[20rem] h-[21rem] lg:w-[20rem] lg:h-[22rem] lg:mr-5 mt-5 lg:mt-[-20px] rounded-2xl object-cover border border-white shadow-2xl shadow-gray-500 z-30 ${className}`}
      initial={{
        filter: "grayscale(0%)",
