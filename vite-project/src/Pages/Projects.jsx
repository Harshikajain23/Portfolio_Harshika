  ...
  return (
    ...
    >
      <div className="w-full flex justify-center items-center p-6 relative">
        ...
        <h1 className="text-2xl lg:text-5xl font-semibold mb-10 bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent uppercase">My Projects</h1>
      </div>
