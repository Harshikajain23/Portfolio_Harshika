  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 h-full px-6">
        ...
        <p className=" text-2xl sm:text-xl lg:text-2xl text-white ml-4 sm:ml-5 sm:mr-5 lg:ml-15 lg:mr-15 leading-relaxed">
        ...
        <p className=" mt-5 text-2xl sm:text-xl lg:text-2xl text-white ml-4 sm:ml-5 sm:mr-5 lg:ml-15 lg:mr-15 leading-relaxed">
       In my final year, I developed a deep learning project on Image Captioning using CNN and LSTM architectures, which strengthened my understanding of neural networks and model implementation.
        ...
        <p className="mt-5 mb-6 text-2xl sm:text-xl lg:text-2xl text-white ml-4 sm:ml-5 sm:mr-5 lg:ml-15 lg:mr-15 leading-relaxed">
